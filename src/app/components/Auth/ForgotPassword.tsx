...
const ForgotPasswordPage = () => {
    ...
    return (
        <section className="w-full mb-20">
            ...
            {/* Description */}
            <p className="text-[#333333] text-[14px] mb-6 ">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <Label
                    htmlFor="email"
                    className="text-[#333333] text-[14px] font-normal block mb-2"
                >
                    Email Address
                </Label>

                {/* Inline input + button */}
                <div className="flex items-stretch max-w-[670px]">
                    <Input
                        id="email"
                        type="email"
                        placeholder=""
                        className="flex-1 h-[50px] bg-white border border-gray-300 rounded-l-sm rounded-r-none px-3 focus:ring-2 focus:ring-[#FD5430] focus:border-[#FD5430] !ring-offset-0"
                        {...register("email", {
                    ...
                    />
                    {loading ? (
                        <div className="flex items-center justify-center w-[160px] bg-[#FD5430] rounded-r-md">
                        ...
                        <Button
                            type="submit"
                            disabled={loading}
                            className="w-[160px] bg-[#FD5430] hover:bg-[#e04a2a] text-white font-medium h-[50px] rounded-l-none rounded-r-sm text-[14px] shrink-0"
                        >
