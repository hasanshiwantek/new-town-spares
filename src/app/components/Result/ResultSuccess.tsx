...
//                     <h1 className="text-[28px] mt-1 text-[#333] font-normal">Thanks for Subscribing! </h1>
//                     <div className="border-none items-center p-3 flex gap-3  mt-5 text-[#545454] bg-[#d5ffd8]">
//                         <svg className="text-[#008a06] fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"></path></svg>
