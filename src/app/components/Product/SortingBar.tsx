...
export default function SortingBar({
  ...
  return (
    <div className="flex xl:flex-row lg:flex-row md:flex-col sm:flex-col flex-col justify-end items-center  2xl:py-[20px] 2xl:px-[30px] xl:py-[15px] xl:px-[22.5px]    p-5 w-full">
      {/* ✅ Dynamic heading */}
      {/* <h4 className="text-[14px] hidden sm:block text-[#333333]">{getFilterTitle()}</h4> */}

      <div className="flex xl:flex-row lg:flex-row md:flex-col sm:flex-row flex-row items-center gap-3 ">
        ...
        <div className="hidden md:flex items-center space-x-2">
          <button
            onClick={() => setView("grid")}
            className={`w-[20px] h-[20px] flex items-center justify-center border transition-colors ${view === "grid"
                ? "bg-[var(--primary-color)] text-white border-orange-500 shadow-md"
                : "bg-white text-gray-600 border-gray-300 hover:bg-gray-100"
              }`}
          >
          ...
          <button
            onClick={() => setView("list")}
            className={`w-[20px] h-[20px] flex items-center justify-center border transition-colors ${view === "list"
